...
import whiteLogo from "../../../public/assets/img/logo/white-logo.png";
import blackLogo from "../../../public/assets/img/logo/black-logo.png";
                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-2 col-lg-6 col-6">
                            <div className="tp-header-logo">
                                <Link href="/">
                                    <Image width={120} className="logo-white" src={whiteLogo} alt="logo-white" />
                                    <Image width={120} className="logo-black d-none" src={blackLogo} alt="logo-black" />
                                </Link>
                            </div>
                        </div>
